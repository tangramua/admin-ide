...
import { GitRepositoryDocument } from '@adminide-stack/core';
...
export const URLRepo = graphql(GitRepositoryDocument, {
  skip: props => !fetcher(props.url), options: (props: any) => {
    const result = fetcher(props.url);
    if (result) {
      return { variables: result };
    }
    return {};
  },
})(URLRepoComponent) as any;
