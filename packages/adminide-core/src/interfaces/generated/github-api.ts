...
export enum IContributionOrderField {
...
export enum IEnterpriseMembershipType {
...
export enum IEnterpriseOrderField {
...
export enum IOauthApplicationRevokeTokensAuditEntryState {
  /** The OAuth Application was active and allowed to have OAuth Accesses. */
  Active = 'ACTIVE',
  /** The OAuth Application was suspended from generating OAuth Accesses due to abuse or security concerns. */
  Suspended = 'SUSPENDED',
...
export enum IPullRequestPubSubTopic {
...
export enum IRegistryPackageDependencyType {
...
export enum IRegistryPackageFileState {
...
export enum IRegistryPackageType {
...
export enum IRepositoryCollaboratorAffiliation {
